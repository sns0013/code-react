                                                ...
                                                <div className="d-flex justify-content-between">
                                                   ...
                                                   <div className="w-100">
                                                      <div className="d-flex justify-content-between flex-wrap">
                                                         <div>
                                                            <h5 className="mb-0 d-inline-block"><Link to="#">User Name</Link></h5>
                                             ...
                                             <div className="user-post-data py-3">
                                                <div className="d-flex  justify-content-between">
                                                   ...
                                                   <div className="w-100">
                                                      <div className="d-flex justify-content-between">
                                                         <div>
                                                            <h5 className="mb-0 d-inline-block me-1"><Link to="#">User Name</Link></h5>
                                 ...
                                 <Card.Body>
                                    ...
                                    <div className="friend-list-tab mt-2">
                                       <Nav variant="pills" className=" d-flex align-items-center justify-content-left friend-list-items p-0 mb-2">
                                          <Nav.Item>
                                             <Nav.Link  href="#pill-all-friends" eventKey="all-friends">Your Electorate</Nav.Link>
                                          </Nav.Item>
                                          <Nav.Item>
                                             <Nav.Link href="#pill-recently-add" eventKey="recently-add">Recently Joined</Nav.Link>
                                          </Nav.Item>
                                       </Nav>
                                       <Tab.Content>
                                                            ...
                                                            <div className="card-header-toolbar d-flex align-items-center">
                                                               <Dropdown>
                                                                  <Dropdown.Toggle className=" btn btn-secondary me-2">
                                                                     <i className="ri-check-line me-1 text-white"></i> Connected
                                                                  </Dropdown.Toggle>
